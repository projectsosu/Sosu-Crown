...
import com.sosu.rest.backend.controller.UserController;
...
public class UserControllerImpl implements UserController {
     ...
     */
    @Override
    public ResponseEntity<Void> uploadFile(MultipartFile file, String username, UserFollowRequest request) {
