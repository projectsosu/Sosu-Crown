...
import com.sosu.rest.backend.service.user.impl.UserServiceImpl;
...
class UserServiceTest {
    ...
    @AfterEach
    void cleanTests() {
        reset(userRepository, securityRepository, userFollowRepository, userMapper, mailService, imageUploader);
    }
